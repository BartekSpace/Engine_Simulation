...
def main():
    ...
    # oxid_formula = oxid_formula.upper()
    # tmp = oxid_formula
    # oxid_formula= ''
    # for i in tmp:
    #     oxid_formula = oxid_formula + i + ' '


    fuel_formula = cea['fuel_formula']
    #fuel_formula = fuel_formula.upper()
    # tmp = fuel_formula
    # fuel_formula = ''
    # for i in tmp:
    #      fuel_formula = fuel_formula + i + ' '
    #      print(fuel_formula)
    ...
    print (fuel_enthalpy)
    print (fuel_formula)
    #print(get_Isp(oxid_name,fuel_name,30,7,5.2920))
    while t[-1]< time:
